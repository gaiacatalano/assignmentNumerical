...
for p=1:length(d)
    ...
    for i = 1:num_points
        ...
        [xk_fd, fk_rand_fd, gradfk_norm_rand_fd, k_rand_fd, xseq_fd, btseq_fd] = ...
            modified_newton_bcktrck(x0_i, problem_213_fun, ...
            problem_213_grad_fd , problem_213_hess_fd, ...
            kmax, tolgrad, c1, rho, btmax);
        x_newton_problem_213_fd = xk_fd;

        [xk_fd_prec, fk_rand_fd_prec, gradfk_norm_rand_fd_prec, k_rand_fd_prec, xseq_fd_prec, btseq_fd_prec] = ...
            modified_newton_bcktrck_preconditioning(x0_i, problem_213_fun, ...
            problem_213_grad_fd , problem_213_hess_fd, ...
            kmax, tolgrad, c1, rho, btmax);
